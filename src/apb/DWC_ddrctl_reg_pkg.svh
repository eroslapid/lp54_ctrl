...
// Revision $Id: //dwh/ddr_iip/umctl5/DWC_ddrctl_lpddr54_MAIN_BR/DWC_ddr_umctl5/src/apb/DWC_ddrctl_reg_pkg.svh#2 $
// -------------------------------------------------------------------------
// Description:
//    Register package
//
...
localparam DFI_LP_EXTRA_GAP_WR_WIDTH = 3;
...
localparam ECC_CORR_SYNDROMES_79_72_WIDTH = 8;
...
localparam ECC_CORR_BIT_MASK_79_72_WIDTH = 8;
...
localparam ECC_UNCORR_SYNDROMES_79_72_WIDTH = 8;
...
localparam ECC_POISON_DATA_79_72_WIDTH = 8;
...
localparam T_SELFREF_EXIT_STAGGER_WIDTH = `DDRCTL_DDR_DCH_STAGGER_BITS+1;
...
localparam MAX_NUM_UNALLOC_ENTRIES_WIDTH = `MEMC_RDCMD_ENTRY_BITS+2;
...
localparam DRAM_RSTN_X1024_WIDTH = 10;
...
localparam ADDRMAP_LUT_MAX_ACTIVE_HIF_ADDR_WIDTH_WIDTH = 5;
localparam ADDRMAP_LUT_RANK_TYPE_WIDTH = `MEMC_NUM_RANKS;
localparam ADDRMAP_LUT_BIT1_WIDTH = 6;
localparam ADDRMAP_LUT_BIT0_WIDTH = 6;
...
localparam BASE_ADDR_WIDTH = `UMCTL2_AXI_SAR_REG_BW;
localparam NBLOCKS_WIDTH = `UMCTL2_AXI_SAR_SW;
...
localparam CAM_MIDDLE_THRESHOLD_HPR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_FREE_THRESHOLD_HPR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_BUSY_THRESHOLD_HPR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_MIDDLE_THRESHOLD_LPR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_FREE_THRESHOLD_LPR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_BUSY_THRESHOLD_LPR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_MIDDLE_THRESHOLD_WR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_FREE_THRESHOLD_WR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
localparam CAM_BUSY_THRESHOLD_WR_WIDTH = `DDRCTL_CHB_HIF_CRDT_CNT_WIDTH;
...
localparam T_MPDPXACT_WIDTH = 11;
localparam T_MPSMX_WIDTH = 7;
localparam T_PD_WIDTH = (`DDRCTL_DDR_DUAL_CHANNEL_EN==1) ? 7 : 6;
localparam T_PDA_H_WIDTH = 2;
localparam T_PDA_LATCH_WIDTH = 8;
localparam T_PDA_DELAY_WIDTH = 8;
localparam T_PDA_DQS_DELAY_WIDTH = 7;
localparam T_PDA_S_WIDTH = 2;
localparam T_CSH_SREXIT_WIDTH = 7;
localparam T_CSL_SREXIT_WIDTH = 5;
...
localparam DFI_TPHY_WRLAT_WIDTH = (`DDRCTL_DDR_DUAL_CHANNEL_EN==1) ? 7 : 6;
...
localparam DFI_TPHY_WRCSLAT_WIDTH = (`DDRCTL_DDR_DUAL_CHANNEL_EN==1) ? 7 : 6;
...
localparam T_REFI_X1_X32_WIDTH = 12;
...
localparam T_ECS_INT_X1024_WIDTH = 12;
...
localparam T_REFI_X1_SEL_2_WIDTH = 1;
...
localparam T_ECS_INT_X1024_2_WIDTH = 12;
