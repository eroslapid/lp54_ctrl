...
// -------------------------------------------------------------------------
// -- Revision: $Id: //dwh/ddr_iip/umctl5/DWC_ddrctl_lpddr54_MAIN_BR/DWC_ddr_umctl5/src/te/te_hmatrix.sv#1 $
// -------------------------------------------------------------------------
// Description:
//
// ----------------------------------------------------------------------------
...
//SMD: Index '[(r_push_entry * CAM_ENTRIES) +:CAM_ENTRIES]' of width '33' is larger than the width '8' required for the max value '255' of the signal 'history_matrix_nxt'
//SJ: This is a false violation. This is due to implicit 32 bits in parameter values.
        history_matrix_nxt[r_push_entry*CAM_ENTRIES+:CAM_ENTRIES] = valid_vct;
...
always @(posedge core_ddrc_core_clk or negedge core_ddrc_rstn) begin
    ...
    else begin // No clock gating because mask can be used anytime (e.g. for ACT/PRE)
       masks_reg <= masks;
    end
end
