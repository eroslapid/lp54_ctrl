...
//
// Description : DWC_ddrctl_bcm07.v Verilog module for DWC_ddrctl
//
// DesignWare IP ID: 01d0b891
//
////////////////////////////////////////////////////////////////////////////////


module DWC_ddrctl_bcm07 (
        clk_push,
        rst_push_n,
        init_push_n,
        push_req_n,
...
`ifndef SYNTHESIS
  ...
  DWC_ddrctl_sva05 #(COUNT_WIDTH, PUSH_SYNC) P_SVA_PUSH_GRAY (
        .clk_d(clk_push),
        .rst_d_n(rst_all),
        .data_s(pop_addr_g) );

  DWC_ddrctl_sva05 #(COUNT_WIDTH, POP_SYNC) P_SVA_POP_GRAY (
        .clk_d(clk_pop),
        .rst_d_n(rst_all),
        .data_s(push_addr_g) );
  ...
  DWC_ddrctl_sva12_c P_RESET_PUSH(
    .clk(clk_push),
    .rst_n(rst_push_n),
    .init_n(init_push_n),
    .req_n(push_req_n)
  ...
  DWC_ddrctl_sva12_c P_RESET_POP(
    .clk(clk_pop),
    .rst_n(rst_pop_n),
    .init_n(init_pop_n),
    .req_n(pop_req_n)
