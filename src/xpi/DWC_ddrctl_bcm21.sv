...
// { START Latency Accurate modeling
  ...
  initial begin
    if (((F_SYNC_TYPE & 7) == 2) && (VERIF_EN == 5) && (BCM_MSG_VERBOSITY[0] == 1'b1))
...
`ifdef DWC_SYNC_1_STAGE_SRC
      ...
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1_N(.clk_d(~clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d) , .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
`else
...
`ifdef DWC_SYNC_2_STAGE_SRC
      DWC_ddrctl_bcm00_sync2 #(WIDTH) U_SAMPLE_META_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(data_d_int));
`else
  `ifdef DWC_SYNC_1_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1(.clk_d(clk_d) , .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d) , .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
  `else
...
`ifdef DWC_SYNC_3_STAGE_SRC
      DWC_ddrctl_bcm00_sync3 #(WIDTH) U_SAMPLE_META_3(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(data_d_int));
`else
  `ifdef DWC_SYNC_2_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_ddrctl_bcm00_sync2 #(WIDTH) U_SAMPLE_META_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
  `else
    `ifdef DWC_SYNC_1_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      ...
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCM_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(sample_syncm));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_syncm), .data_d(data_d_int));
    `else
      reg    [WIDTH-1:0]      sample_meta;
...
`ifdef DWC_SYNC_4_STAGE_SRC
      DWC_ddrctl_bcm00_sync4 #(WIDTH) U_SAMPLE_META_4(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(data_d_int));
`else
  `ifdef DWC_SYNC_3_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_ddrctl_bcm00_sync3 #(WIDTH) U_SAMPLE_META_3(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
  `else
    `ifdef DWC_SYNC_2_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      DWC_ddrctl_bcm00_sync2 #(WIDTH) U_SAMPLE_META_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync2 #(WIDTH) U_SAMPLE_SYNCL_2(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(data_d_int));
    `else
      `ifdef DWC_SYNC_1_STAGE_SRC
      wire [WIDTH-1:0] sample_meta;
      ...
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_META_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(data_s), .data_d(sample_meta));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCM1_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_meta), .data_d(sample_syncm1));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCM2_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_syncm1), .data_d(sample_syncm2));
      DWC_ddrctl_bcm00_sync1 #(WIDTH) U_SAMPLE_SYNCL_1(.clk_d(clk_d), .rst_d_n(rst_d_n), .data_s(sample_syncm2), .data_d(data_d_int));
      `else
      reg    [WIDTH-1:0]      sample_meta;
      reg    [WIDTH-1:0]      sample_syncm1;
