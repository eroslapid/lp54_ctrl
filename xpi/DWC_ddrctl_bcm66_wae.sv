...
//
// Description : DWC_ddrctl_bcm66_wae.v Verilog module for DWC_ddrctl
//
// DesignWare IP ID: 99b8761f
//
////////////////////////////////////////////////////////////////////////////////



module DWC_ddrctl_bcm66_wae(
                clk_push,
                rst_push_n,
                init_push_n,
                push_req_n,
...
parameter integer ADDR_WIDTH = 3;       // RANGE 1 to 8
parameter integer COUNT_WIDTH = 4;      // RANGE 2 to 9
...
// spyglass enable_block W287b
    ...
    generate if ((MEM_MODE&3) == 0) begin : GEN_MM_EQ_0
